...
PDF_OUT = BASE / "relatorio-americana-temasdiversos-ago2026.pdf"
...
async def main():
    ...
    async with async_playwright() as p:
        exe = Path.home() / "Library/Caches/ms-playwright/chromium-1234/chrome-mac-x64/Google Chrome for Testing.app/Contents/MacOS/Google Chrome for Testing"
        browser = await p.chromium.launch(executable_path=str(exe)) if exe.exists() else await p.chromium.launch()
